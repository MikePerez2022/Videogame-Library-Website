...
namespace VideoGameLibrary.Data
{
    public class GameCollectionDAL : IDataAccessLayer
    {
        ...
        private static List<VideoGame> GameList = new List<VideoGame>()
        {
            ...
            factory.CreateGame("Skrim", 2011, "PC", "RPG", "M", "https://upload.wikimedia.org/wikipedia/en/1/15/The_Elder_Scrolls_V_Skyrim_cover.png"),
            factory.CreateGame("Fallout New Vegas", 2010, "PC", "RPG", "M", "https://upload.wikimedia.org/wikipedia/en/3/34/Fallout_New_Vegas.jpg"),
            factory.CreateGame("Fallout 4", 2015, "Xbox One", "RPG", "M", "https://image.api.playstation.com/vulcan/ap/rnd/202009/2500/D59jxQR99Jg545NKa4Nu1FmP.png"),
            factory.CreateGame("Titanfall 2", 2016, "Xbox One", "FPS", "M", "https://upload.wikimedia.org/wikipedia/en/1/13/Titanfall_2.jpg")
        };
        ...
        {
            return new GenreVideoGameIterator(GameList, genre);
        }

        public IVideoGameIterator GetPlatformIterator(string platform)
        {
            return new PlatformVideoGameIterator(GameList, platform);
        }
    }
}
